...
func main() {
	...
	// PART TWO:
	// Take the value of Wire A
	aValue := FindWire("a").Value

	// Then attach that value to Wire B
	bSignal := NewSignal(aValue)
	FindWire("b").Inputs = []*Node{bSignal}
